...
namespace App\Jobs\FollowupReportTasks;
...
class SendMessageToAssignedFollowUpReportTask implements ShouldQueue
{
    ...
    {
        try {
            logger('SendMessageToAssignedFollowUpReportTask');
            ...
            if ($contactGroup instanceof ContactGroup) {
                foreach ($contacts as $contact) {
                    if ($contact instanceof Contact) {
                        ...
                        $requestData['message'] = "Dear " . $contact->full_name . " you are assigned to new followup.\nUNIQUE CODE: " . $contactGroup->unique_code . "\n" . $this->message;
